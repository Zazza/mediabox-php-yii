define(function (require) {
    ...
    $("#volume").kendoSlider({
        ...
        change: function(e) {
            $.ajax({type:"GET",url: "/app/volume/",data:"level="+e.value});
...
$(document).ready(function() {
    ...
    $(".droptarget").kendoDropTarget({
        drop: function(e) {
            ...
            // Save playlist
            $.ajax({ type: "POST", url: '/audio/save-list/', dataType: "JSON", data: e.draggable.currentTarget.attr("data-id"), cache: false })
                .done(function(data) {
